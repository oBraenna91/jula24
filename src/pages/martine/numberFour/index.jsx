...
import img1 from '../../../images/IMG_46299C8015FB-1.jpeg';
...
export default function MartineQ4Screen() {
    ...
    return(
        <div className="col-12 appearing-container d-flex flex-column align-items-center pb-5">
            ...
            <ScrollingComponent containerName="container4">
                    ...
                    {['I trusa til Charlotte', 'Inni kaffetrakteren', 'I et av putetrekkene på rommet ditt'].map((name, index) => (
                        <div
                            key={index}
